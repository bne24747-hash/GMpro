...
function sel(b,s,c){fetch('/select?b='+b+'&s='+s+'&c='+c).then(()=>alert('Target Locked!'));}
...
function stSpam(){fetch('/setspam?n='+document.getElementById('bN').value).then(()=>alert('Set!'));}
function setEt(){fetch('/setetpage?p='+document.getElementById('etS').value).then(()=>alert('Set!'));}
...
function chk(){fetch('/status').then(r=>r.json()).then(s=>{if(s.m)document.getElementById('kill').classList.add('active');if(s.d)document.getElementById('deauth').classList.add('active');if(s.s)document.getElementById('spam').classList.add('active');if(s.e)document.getElementById('evil').classList.add('active');});}
window.onload=chk;
