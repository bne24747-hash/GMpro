 ...
 * UPDATE: Hidden Support, Custom Spam SSID, Clone Target, & Spam Quantity
 */
...
void handleIndex() {
  ...
  p += "<div class='ctrl'><form method='post' action='/?deauth=" + String(deauthing_active?"stop":"start") + "' style='flex:1'><button class='cmd' style='background:" + String(deauthing_active?"#f00":"#0c8") + ";width:98%'>DEAUTH</button></form><form method='post' action='/?rusuh=" + String(mass_deauth?"stop":"start") + "' style='flex:1'><button class='cmd' style='background:" + String(mass_deauth?"#f00":"#e60") + ";width:98%'>RUSUH</button></form><form method='post' action='/?beacon=" + String(beacon_active?"stop":"start") + "' style='flex:1'><button class='cmd' style='background:" + String(beacon_active?"#f00":"#60d") + ";width:98%'>BEACON</button></form><form method='post' action='/?hotspot=" + String(hotspot_active?"stop":"start") + "' style='flex:1'><button class='cmd' style='background:" + String(hotspot_active?"#f00":"#a53") + ";width:98%'>EVILTWIN</button></form></div></body></html>";
